...
This section will discuss use cases and evaluation of the research. The data used were taken from Wikidata and retrieved using Wikidata Query Service. The data is then processed and analyzed using a Python library that we created.
